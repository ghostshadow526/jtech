...
export function LoginPage({ 
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-brand-900 via-brand-950 to-brand-900 p-12 text-white">
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="lg:hidden flex items-center justify-center gap-2 text-lg font-semibold mb-12">
            <div className="size-8 rounded-lg bg-brand-950/10 flex items-center justify-center">
              <Sparkles className="size-4 text-brand-950" />
            </div>
            <span>JT Tech</span>
          </div>
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">
              {mode === 'login' ? 'Please enter your details' : 'Join JT Technologies today'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 bg-background border-border/60 focus:border-brand-950"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-background border-border/60 focus:border-brand-950"
                />
                <button
                  type="button"
            ...
            <Button 
              type="submit" 
              className="w-full h-12 text-base font-medium bg-brand-950 hover:bg-brand-900" 
              size="lg" 
              disabled={isLoading}
            >
          ...
          <div className="text-center text-sm text-muted-foreground mt-8">
            ...
            <button 
              ...
              className="text-brand-950 font-medium hover:underline"
            >
